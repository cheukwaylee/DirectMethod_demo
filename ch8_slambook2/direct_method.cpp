    ...
    Sophus::SE3d &T21)
{
    ...
    auto time_used = chrono::duration_cast<chrono::duration<double>>(t2 - t1); // unit: second
    cout << "single layer time: " << time_used.count()*1000 <<" ms"<< endl;
