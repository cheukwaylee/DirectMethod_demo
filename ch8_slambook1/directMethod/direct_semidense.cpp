...
public:
    ...
    virtual void computeError()
    {
        ...
        {
            // getPixelValue(x, y) 当前灰度
            // _measurement 第一张图的灰度值（像素梯度大的点）
            _error(0, 0) = getPixelValue(x, y) - _measurement; // 当前灰度 减去 第一张图
        }
    }
    ...
    Eigen::Isometry3d &Tcw)
{
    ...
    */
    ...
    for (Measurement m : measurements)
    {
        ...
        edge->setMeasurement(m.grayscale); // 第一张图的灰度值（像素梯度大的点）
